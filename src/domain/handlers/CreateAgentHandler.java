...
public class CreateAgentHandler extends ObtainUsersHandler implements ICreateAgentHandler {
	...
	public boolean defineAccessKey(String access, String verifier) {
		System.out.println("CreateAgentHandler: defineAccessKey(\"" + access + "\", \"" + verifier + "\")");
	...
	public void defineKeyAndCoding(String key, String codifier) {
		System.out.println("CreateAgentHandler: defineKeyAndCoding(\"" + key + "\", \"" + codifier + "\")");
	}
