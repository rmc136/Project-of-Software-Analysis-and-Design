...
public class CreateMissionHandler extends ObtainUsersHandler implements ICreateMissionHandler {
	...
	public boolean selectResponsible(String codeName, String accessK) {
		System.out.println("CreateMissionHandler: selectResponsible(\"" + codeName + "\")");
		return !codeName.equals("fail");
	}
	
	@Override
	public boolean selectAgent(String codeName, String accessK) {
		System.out.println("CreateMissionHandler: selectAgent(\"" + codeName + "\")");
		return !codeName.equals("fail");
	}
	
	@Override
	public void defineKeyword(String keyword) {
		System.out.println("CreateMissionHandler: defineKeyword(\"" + keyword + "\")");
	}
	
	@Override
	public boolean selectUser(String userName) {
		System.out.println("CreateMissionHandler: selectUser(\"" + userName + "\")");
